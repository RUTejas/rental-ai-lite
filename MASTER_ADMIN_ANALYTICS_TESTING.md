...
7. Sign in as Master Admin through `/master-admin-login?key=...`; open Website & app analytics and verify cards/charts/tables use stored data.
...
15. Deploy to Vercel and repeat public route, HTTPS, manifest, service-worker, and hidden portal checks.
